...
from torch_geometric.datasets import Planetoid, CitationFull, WikiCS, Coauthor, Amazon, WikipediaNetwork, Actor, WebKB
...
def get_dataset(path, name):
    assert name in ['Cora', 'CiteSeer', 'PubMed', 'DBLP', 'Karate', 'WikiCS', 'Coauthor-CS', 'Coauthor-Phy',
                    'Amazon-Computers', 'Amazon-Photo', 'ogbn-arxiv', 'ogbg-code', 'chameleon', 'squirrel', 'actor', 'cornell', 'texas', 'wisconsin']
    name = 'dblp' if name == 'DBLP' else name
